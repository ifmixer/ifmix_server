package com.ifmix.api.core.customer.modules.iap

import com.ifmix.api.core.common.modules.iap.dto.SubscriptionState
...
class IapTypesTest {
    ...
    fun tierOf_returnsTier_whenMatched() {
        ...
        assertThat(tierOf("premium_monthly", map)).isEqualTo(com.ifmix.api.core.common.entity.enums.Tier.PRO)
        assertThat(tierOf("enterprise_yearly", map)).isEqualTo(com.ifmix.api.core.common.entity.enums.Tier.ENTERPRISE)
    }
    ...
    fun tierOf_handlesMixedCaseMapValue() {
        ...
        assertThat(tierOf("basic", map)).isEqualTo(com.ifmix.api.core.common.entity.enums.Tier.FREE)
    }
}
