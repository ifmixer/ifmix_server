package com.ifmix.api.core.customer.bff.webhooks
...
import com.ifmix.api.core.common.modules.iap.service.IapService
    ...
    fun handleApple(@RequestBody rawPayload: String): ResponseEntity<String> {
        try {
            ...
            val appId = if (bundleId != null) {
                appConfigRepo.findByBundleId(com.ifmix.api.core.common.infra.db.RepoContext.DEFAULT, bundleId)?.appId
            } else null
    ...
    fun handleGoogle(@RequestBody rawPayload: String): ResponseEntity<String> {
        try {
            ...
            val appId = if (packageName != null) {
                appConfigRepo.findByAndroidPackage(com.ifmix.api.core.common.infra.db.RepoContext.DEFAULT, packageName)?.appId
            } else null
