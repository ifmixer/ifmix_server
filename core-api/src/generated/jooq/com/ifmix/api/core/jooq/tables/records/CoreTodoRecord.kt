 ...
 */
@Suppress("warnings")
open class CoreTodoRecord private constructor() : UpdatableRecordImpl<CoreTodoRecord>(CoreTodo.CORE_TODO), ICoreTodo {
     ...
     * Create a detached, initialised CoreTodoRecord
     */
    constructor(value: ICoreTodo?): this() {
        if (value != null) {
            this.id = value.id
