...
open class ScanCollectionFacadeService(
    private val queries: ScanCollectionQueries,
    private val commands: ScanCollectionCommands,
    ...
    fun getDefault(ctx: OperationContext): ScanCollection = tx.withTx(svc(ctx)) { sc ->
        queries.getDefault(sc) ?: commands.createDefaultCollection(sc)
    }
