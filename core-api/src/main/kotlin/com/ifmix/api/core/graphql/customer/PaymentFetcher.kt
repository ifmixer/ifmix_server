...
/**
 * GraphQL Payment fetcher — customer BFF。
 * 将 Schema input 映射为 PaymentFacade 的 VerifyReq，再将响应展平为 VerifyPurchaseResult。
 */
@DgsComponent
class PaymentFetcher(private val paymentFacade: PaymentFacade) {

    @DgsMutation(field = "mutation_payment_verifyPurchase")
    fun verifyPurchase(
        ...
        val res = paymentFacade.verifyPurchase(ctx, req)
