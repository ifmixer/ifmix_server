...
class AppConfigInternalService(
    ...
    fun createOneRevision(sc: SvcCtx, req: CreateRevisionInput): RevisionDto {
        val appId = sc.appId!!
        ...
        return toDto(revisionRepo.insert(sc, revision))
    }

    fun toggleRevision(sc: SvcCtx, revisionId: UUID, enabled: Boolean): RevisionDto {
        val appId = sc.appId!!
