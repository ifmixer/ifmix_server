...
class CollectionEntity : BaseAppEntity() {
    ...
    /** 安装标识（匿名场景下唯一标识用户），ObjectId hex 字符串。 */
    var installId: String? = null

    /** 用户 ID（登录场景），ObjectId hex 字符串。 */
...
fun CollectionEntity.toCollection(): com.ifmix.api.core.graphql.generated.types.Collection =
    com.ifmix.api.core.graphql.generated.types.Collection(
