...
CREATE TABLE public.auth_refreshtoken (
    ...
    app_id uuid CONSTRAINT auth_appuser_refreshtoken_app_id_not_null NOT NULL,
...
--
-- Name: auth_identity_app_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX auth_identity_app_idx ON public.auth_identity USING btree (app_id);

--
-- Name: auth_identity_rel_app_authidentity_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX auth_identity_rel_app_authidentity_idx ON public.auth_identity_to_idpidentity_relation USING btree (app_id, auth_identity_id);

--
-- Name: auth_identity_rel_app_idpidentity_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX auth_identity_rel_app_idpidentity_idx ON public.auth_identity_to_idpidentity_relation USING btree (app_id, idp_identity_id) WHERE (deleted_at IS NULL);
...
CREATE INDEX auth_refreshtoken_app_hash_idx ON public.auth_refreshtoken USING btree (app_id, token_hash);
...
CREATE INDEX customer_auth_identity_idx ON public.customer USING btree (app_id, auth_identity_id);

--
-- Name: feedback_app_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX feedback_app_created_idx ON public.cs_feedback USING btree (app_id, created_at);
...
CREATE INDEX ix_cs_support_request_owner ON public.cs_support_request USING btree (app_id, customer_id, id DESC);
